<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ASPxGridRibbon.ascx.cs" Inherits="ASPxGridRibbon" %>
...
<%@ Register Assembly="DevExpress.Web.v13.2, Version=13.2.15.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" Namespace="DevExpress.Web.ASPxRibbon" TagPrefix="dx" %>
        ...
        function RibbonCommand(s, e) {
            switch (e.item.name) {
                ...
                case "Refresh":
                    ...
                    break;
                case "Export":
                        <%= Page.ClientScript.GetPostBackEventReference(this, "Export") %>
				    break;
                case "PreviousPage":
                ...
                case "BatchEditionMode":
                        <%= Page.ClientScript.GetPostBackEventReference(this, "EditingMode") %>
				    break;
                case "DiscardChanges":
                    s.cpGrid.CancelEdit();
                    break;
